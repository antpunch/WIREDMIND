...
label start:
    ...
    scene hospital with dissolve
    show mc happy onlayer character_over_text at portrait
    mc "It's [mcname]."
    ...
    koaanon "All citizens stand clear!"
...
label ask:
    ...
    show mc angry onlayer character_over_text at portrait
    mc "Hey, no peeking!"
    mc "(Aside from my interview notes with our patients, my journal holds a lot of my personal thoughts on the virus as well.)"
    mc "(Definitely not something I'd want just anyone to see. Certainly not something I would want to show to a government worker.)"
    mc "(You never know who might report {i}what{/i} to higher ups.)"
...
label main:
    ...
    mc "(It's so unusual for an expedition to be so public like that.)"
    ...
    if ask:
        ...
        show mc sad onlayer character_over_text at portrait
        mc "(Though it's unlikely that I'll ever get the chance to even talk with him again.)"
